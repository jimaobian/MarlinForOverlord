...
extern const uint8_t printGfx[] PROGMEM;
extern const uint8_t overlordTextGfx[] PROGMEM;
extern const uint8_t advancedGfx[] PROGMEM;
extern const uint8_t maintenanceGfx[] PROGMEM;
